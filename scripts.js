...
// let ans = [1,2,2,3,3,1,1,1,1,1].reduce((acc, curr) =>{
...
this.cast.push(castName);
    ...
    removeCast(castName){
let newArray = this.cast.filter(v =>{
...
let m1 = new Movie('sdsds', 3, ['hello'])